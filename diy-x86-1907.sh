...
#echo '修改feeds'
#sed -i '3s/Lienol/coolsnowwolf/g' ./feeds.conf.default
...
svn checkout https://github.com/sypopo/openwrt-package/trunk/lienol/luci-app-passwall/  package/lienol/tcpping
