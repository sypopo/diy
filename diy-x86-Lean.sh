...
echo '添加软件包'
git clone https://github.com/vernesong/OpenClash.git package/vernesong/luci-app-openclash
git clone https://github.com/xiaorouji/openwrt-passwall.git package/xiaorouji/openwrt-passwall
